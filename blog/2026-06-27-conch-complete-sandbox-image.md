...
description: Conch 如何用完整沙箱镜像统一表达 rootfs、沙箱启动组件和可选的内存运行快照。
---
...
![OCI 镜像与 Conch 完整沙箱镜像格式对比图](/img/blog/conch-complete-sandbox-image/oci-vs-conch.png)
...
![Conch Boot Index 与 Manifest 结构示意图](/img/blog/conch-complete-sandbox-image/boot-index-manifest.png)
...
![Conch 镜像工作流总览图](/img/blog/conch-complete-sandbox-image/image-workflow.png)
...
![Conch 完整沙箱镜像端到端验证流程](/img/blog/conch-complete-sandbox-image/end-to-end.gif)
...
**【版权声明】** Copyright © 2026 openEuler Community。本文由openEuler社区首发，欢迎遵照 [CC-BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/legalcode) 协议规定转载。转载时敬请在正文注明并保留原文链接和作者信息。
